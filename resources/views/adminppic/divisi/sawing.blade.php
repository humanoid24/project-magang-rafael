...
@section('content')
<h1 class="h3 mb-2 text-gray-800 text-center">Table Kerja Sawing</h1>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="GET" action="{{ route('ppic.sawing.filter') }}">
...
<div class="card shadow mb-4">
  @if (in_array(Auth::user()->role, [1, 3]))
    <div class="card-header py-3">
        ...
        <form action="{{ route('ppic.delete.sawing') }}" method="POST" style="display:inline;">
            @csrf
            @method('DELETE')
  ...
  @endif
    ...
    <div class="card-body">
        <div class="d-flex justify-content-end mb-3">
          <!-- Search Form -->
          <form method="GET" action="{{ route('ppic.sawing') }}" class="d-flex" role="search">
