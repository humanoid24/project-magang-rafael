...
@section('content')
<h1 class="h3 mb-2 text-gray-800 text-center">Table Kerja Welding Shofiting 2</h1>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="GET" action="{{ route('ppic.weldingshofiting2.filter') }}">
...
<div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exportModalLabel">Export Laporan Welding Shofiting 2</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
      ...
      <div class="modal-body">
        <form method="GET" action="{{ route('ppic.export.weldingshofiting2') }}">
            <div class="mb-3">
...
<div class="card shadow mb-4">
  @if (in_array(Auth::user()->role, [1, 3]))
    <div class="card-header py-3">
        ...
        <form action="{{ route('ppic.delete.weldingshofiting2') }}" method="POST" style="display:inline;">
            @csrf
            @method('DELETE')
  ...
  @endif
    ...
    <div class="card-body">
        <div class="d-flex justify-content-end mb-3">
          <!-- Search Form -->
          <form method="GET" action="{{ route('ppic.weldingshofiting2') }}" class="d-flex" role="search">
